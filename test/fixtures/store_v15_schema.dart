// The local schema as shipped in 1.0.2 (database version 15), copied from
// main so upgrading a store install can be tested against the real thing.
...
const String storeV15SchemaSql = r'''
-- 1. RUNNERS
...
List<String> splitStoreSql(String script) {

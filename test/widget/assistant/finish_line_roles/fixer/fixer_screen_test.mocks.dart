...
class MockFixerController extends _i1.Mock implements _i2.FixerController {
  ...
  @override
  List<_i4.Runner> get searchResults =>
      (super.noSuchMethod(
  ...
  int get unresolvedCount =>
      (super.noSuchMethod(Invocation.getter(#unresolvedCount), returnValue: 0)
          as int);
  ...
  @override
  List<_i6.RaceRecord> get races =>
      (super.noSuchMethod(
            Invocation.getter(#races),
            returnValue: <_i6.RaceRecord>[],
          )
          as List<_i6.RaceRecord>);
  ...
  void detachSession() => super.noSuchMethod(
    Invocation.method(#detachSession, []),
    returnValueForMissingStub: null,
  );
  ...
  _i7.Future<_i9.Result<void>> processLoadedRaceData(String? data) =>
      (super.noSuchMethod(
            ...
            returnValue: _i7.Future<_i9.Result<void>>.value(
              _i5.dummyValue<_i9.Result<void>>(
                this,
                Invocation.method(#processLoadedRaceData, [data]),
              ),
            ),
  ...
  @override
  _i7.Future<void> joinRace() =>
      (super.noSuchMethod(
            Invocation.method(#joinRace, []),
            returnValue: _i7.Future<void>.value(),
            returnValueForMissingStub: _i7.Future<void>.value(),
          )
          as _i7.Future<void>);
  ...
  @override
  _i7.Future<void> deleteRaceFromLobby(int? raceId) =>
      (super.noSuchMethod(
  ...
  @override
  void resolveWithRunner(int? entryId, _i4.Runner? runner) =>
      super.noSuchMethod(
        Invocation.method(#resolveWithRunner, [entryId, runner]),
        returnValueForMissingStub: null,
      );

  @override
  void resolveWithBib(int? entryId, int? newBib) => super.noSuchMethod(
    Invocation.method(#resolveWithBib, [entryId, newBib]),
    returnValueForMissingStub: null,
  );

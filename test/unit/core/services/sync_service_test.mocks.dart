...
class MockIDatabaseConnectionProvider extends _i1.Mock
  ...
  @override
  _i4.Future<void> openForUser(String? userId) => (super.noSuchMethod(
        Invocation.method(
          #openForUser,
          [userId],
        ),
  ...
  @override
  _i4.Future<void> deleteUserData(String? userId) => (super.noSuchMethod(
        Invocation.method(
          #deleteUserData,
          [userId],
        ),
...
class MockIAuthService extends _i1.Mock implements _i8.IAuthService {
  ...
  @override
  _i4.Future<_i3.AuthResponse> verifyEmailOtp(
    String? email,
    String? token,
  ) =>
      (super.noSuchMethod(

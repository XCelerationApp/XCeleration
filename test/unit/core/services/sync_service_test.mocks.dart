...
class MockIDatabaseConnectionProvider extends _i1.Mock
  ...
  @override
  _i4.Future<void> openForUser(String? userId) =>
      (super.noSuchMethod(
            Invocation.method(#openForUser, [userId]),
  ...
  @override
  _i4.Future<void> deleteUserData(String? userId) =>
      (super.noSuchMethod(
...
class MockIRemoteSyncClient extends _i1.Mock implements _i7.IRemoteSyncClient {
  ...
  _i4.Future<List<Map<String, dynamic>>> fetchByUuids(
    ...
    List<String>? uuids,
      ...
      (super.noSuchMethod(
            Invocation.method(#fetchByUuids, [table, uuids]),
            returnValue: _i4.Future<List<Map<String, dynamic>>>.value(
              <Map<String, dynamic>>[],
            ),
          )
...
class MockIAuthService extends _i1.Mock implements _i8.IAuthService {
  ...
  @override
  _i4.Future<_i3.AuthResponse> verifyEmailOtp(String? email, String? token) =>
      (super.noSuchMethod(
  ...
  @override
  _i4.Future<_i3.AuthResponse> verifyPasswordResetOtp(
    String? email,
    String? token,
  ) =>
      (super.noSuchMethod(
